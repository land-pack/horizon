var App = {
    ...
    _navDoc: function() {
        ...
        function a() {
            n.off("resize.theme.nav"), n.off("scroll.theme.nav"), e.css({
                position: "",
                left: "",
                top: ""
            })
        ...
        function o() {
            ...
            function a() {
                var t = n.scrollTop(),
                    a = Math.max(t - o.containerTop, 0);
                return a ? void e.css({
                    position: "fixed",
                    left: o.containerRight,
                    top: 40
                }) : ($(e.find("li a")[1]).addClass("active"), e.css({
                    position: "",
                    left: "",
                    top: ""
                }))
            ...
            var o = {};
            t(), $(window).on("resize.theme.nav", t).on("scroll.theme.nav", a), $("body").scrollspy({
                target: "#markdown-toc",
                children: "li > a"
            }), setTimeout(function() {
        ...
        var e = $("#markdown-toc"),
            n = $(window);
        e[0] && ($("#markdown-toc li").addClass("nav-item"), $("#markdown-toc li > a").addClass("nav-link"), t(), n.on("resize", t))
    },
