...
+function(t) {
                        ...
                        for (var a in s)
                            if (s.hasOwnProperty(a)) {
                                var o = s[a],
                                    r = n[a],
                                    h = r && i(r) ? "element" : e(r);
                                if (!new RegExp(o).test(h))
                                    throw new Error(t.toUpperCase() + ": " + ('Option "' + a + '" provided type "' + h + '" ') + ('but expected type "' + o + '".'))
                            }
                    }
                };
            return o(), c
                ...
                y = function() {
                    ...
                    return l.prototype.next = function() {
                        ...
                        var n = this,
                            ...
                            l = void 0,
                            c = void 0;
                        if (e === _.NEXT ? (h = v.LEFT, l = v.NEXT, c = _.LEFT) : (h = v.RIGHT, l = v.PREV, c = _.RIGHT), o && t(o).hasClass(v.ACTIVE))
                        ...
                        return this.each(function() {
                            ...
                            if (i || (i = new l(this, s), t(this).data(r, i)), "number" == typeof e)
                                i.to(e);
                ...
                D = function() {
                    ...
                    return l.prototype.toggle = function(t) {
                        ...
                        if (this._isShown && this._config.backdrop) {
                            ...
                            }), s && a.reflow(this._backdrop), t(this._backdrop).addClass(m.SHOW), !e)
                                return;
                            if (!s)
                                return void e();
                ...
                T = function() {
                    ...
                    return l.prototype.enable = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            if (a.supportsTransitionEnd() && t(this.tip).hasClass(m.FADE))
                                return this._isTransitioning = !0, void t(this.tip).one(a.TRANSITION_END, u).emulateTransitionEnd(l._TRANSITION_DURATION);
                            u()
                        }
                    }, l.prototype.hide = function(e) {
                        var i = this,
                        ...
                        var n = this.constructor.DATA_KEY;
                        if (i = i || t(e.currentTarget).data(n), i || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(n, i)), e && (i._activeTrigger["focusout" === e.type ? y.FOCUS : y.HOVER] = !1), !i._isWithActiveTrigger())
                            return clearTimeout(i._timeout), i._hoverState = g.OUT, i.config.delay && i.config.delay.hide ? void (i._timeout = setTimeout(function() {
    ...
    (function(a) {
        ...
        var e = "scrollspy",
            ...
            m = function() {
                ...
                return l.prototype.refresh = function() {
                    ...
                    var n = t(i.join(","));
                    if (n.hasClass(p.DROPDOWN_ITEM))
                        n.closest(g.DROPDOWN).find(g.DROPDOWN_TOGGLE).addClass(p.ACTIVE), n.addClass(p.ACTIVE);
                    else {
        ...
        i.VERSION = "3.3.6", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
            ...
            if ("bottom" == this.affixed)
                return null != i ? !(s + this.unpin <= a.top) && "bottom" : !(s + o <= t - n) && "bottom";
    ...
    !function(t, e) {
        ...
        function r(e, i) {
            ...
            for (var h in a)
                i.test(h) && (s = h.replace(r, n), o[s] = a[h]);
            return o
        }
        function h(e) {
            var i = {};
        ...
        c.prototype = {
            ...
            _applyEvents: function(t) {
                for (var i, n, s, a = 0; a < t.length; a++)
                    i = t[a][0], 2 === t[a].length ? (n = e, s = t[a][1]) : 3 === t[a].length && (n = t[a][1], s = t[a][2]), i.on(s, n)
            },
            _unapplyEvents: function(t) {
                for (var i, n, s, a = 0; a < t.length; a++)
                    i = t[a][0], 2 === t[a].length ? (s = e, n = t[a][1]) : 3 === t[a].length && (s = t[a][1], n = t[a][2]), i.off(n, s)
            },
            ...
            fill: function() {
                ...
                if (!isNaN(a) && !isNaN(o)) {
                    ...
                    for (var b, O = t.map(this.dates, function(t) {
                        ...
                        b = ["year"], k === -1 ? b.push("old") : 10 === k && b.push("new"), t.inArray(a, O) !== -1 && b.push("active"), (a < r || a > l) && b.push("disabled"), D += '<span class="' + b.join(" ") + '">' + a + "</span>", a += 1;
                    S.html(D)
                }
            },
            ...
            moveMonth: function(t, i) {
                ...
                for (; s();)
                    a.setUTCDate(--o), a.setUTCMonth(n);
                return a
            },
        ...
        var u = t.fn.datepicker,
            f = function(i) {
                ...
                return this.each(function() {
                    ...
                    if ("string" == typeof i && "function" == typeof l[i] && (a = l[i].apply(l, s), a !== e))
                        return !1
                }), a !== e ? a : this
            };
        t.fn.datepicker = f;
            ...
            m = {
                ...
                parseDate: function(n, s, a) {
                    ...
                    if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(n)) {
                        for (n = new Date, l = 0; l < u.length; l++)
                            switch (r = d.exec(u[l]), h = parseInt(r[1]), r[2]) {
                            case "d":
                    ...
                    if (u.length !== y.length && (y = t(y).filter(function(e, i) {
                        ...
                        for (l = 0, T = y.length; l < T; l++) {
                            if (f = parseInt(u[l], 10), r = y[l], isNaN(f))
                                switch (r) {
                                case "MM":
                        ...
                        for (l = 0; l < v.length; l++)
                            C = v[l], C in g && !isNaN(g[C]) && (E = new Date(n), D[C](E, g[C]), isNaN(E) || (n = E))
                    }
                    return n
                },
                formatDate: function(e, i, n) {
                    ...
                    for (var a = t.extend([], i.separators), o = 0, r = i.parts.length; o <= r; o++)
                        a.length && e.push(a.shift()), e.push(s[i.parts[o]]);
                    return e.join("")
                },
